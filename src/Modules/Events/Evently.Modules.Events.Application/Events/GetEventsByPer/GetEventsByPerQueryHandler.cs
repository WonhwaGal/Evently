...
public sealed class GetEventsByPerQueryHandler(
	IDbConnectionFactory dbConnectionFactory) : IQueryHandler<GetEventsByPerQuery, IReadOnlyList<EventResponse>>
{
    public async Task<Result<IReadOnlyList<EventResponse>>> Handle(GetEventsByPerQuery request, CancellationToken cancellationToken)
    {
